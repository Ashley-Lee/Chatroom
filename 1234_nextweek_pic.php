...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container">
      ...
      <div id="msg"><form method="post" action="add1234.php" name="form" >
...
$('form[name=form]').submit(function(e) {
   ...
   if (addedToDB == 0) {
    ...
    var messageCount = 0;
    var messages = ["Hello, I am Sam. Nice to e-meet you.", "<span style='color: blue'> Experimenter: Great, we will give you both an icebreaker question to help get to know each other. <b> How about describing your plans for the next weekend? </b> </p> </span>", "I am going to Cancun next week. My parents paid for my flight and all-inclusive hotel expenses and I am already excited! This is the view from a hotel room in Cancun where I will stay for a couple of days."];
